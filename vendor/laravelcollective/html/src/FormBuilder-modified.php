...
class FormBuilder-modified
{
     ...
     * @return \Illuminate\Support\HtmlString
     */
    public function checkbox($name, $value = 1, $checked = null, $options = [], $readonly = null)
    {
        return $this->checkable('checkbox', $name, $value, $checked, $options, $readonly);
    }
     ...
     * @return \Illuminate\Support\HtmlString
     */
    public function radio($name, $value = null, $checked = null, $options = [], $readonly = null)
    {
        if (is_null($value)) {
            $value = $name;
        }

        return $this->checkable('radio', $name, $value, $checked, $options, $readonly);
    }
     ...
     * @return \Illuminate\Support\HtmlString
     */
    protected function checkable($type, $name, $value, $checked, $options, $readonly)
    {
